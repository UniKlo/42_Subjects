...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/03 13:56:02 by khou              #+#    #+#             */
/*   Updated: 2019/04/03 13:59:45 by khou             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Vector {
	...
	public function normalize() {
		...
		if ($vector == 1)
			return clone $this;
		return new Vector(array('dest' => new Vertex(array('x' => $this->_x / $vector, 'y' => $this->_y / $vector, 'z' => $this->_z / $vector))));
	}
